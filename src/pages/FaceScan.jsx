...
<div className="absolute top-4 left-1/2 -translate-x-1/2 w-[90%] max-w-4xl px-6 py-3 flex items-center justify-between bg-white/10 backdrop-blur-xl border border-white/20 rounded-full shadow-[0_0_25px_rgba(0,0,0,0.4)] z-50">
  ...
  <div className="flex items-center gap-2">
    ...
    <div className="absolute left-1/2 -translate-x-1/2 flex items-center gap-2 text-sm text-red-400">
